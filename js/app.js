...
function modal(title,body){const el=$('#appModal'); if(!el)return; const card=el.querySelector('.modal-card'); if(card) card.classList.toggle('is-menu-modal', title==='전체 메뉴'); $('#modalTitle').textContent=title; $('#modalBody').innerHTML=body; el.classList.add('is-open');}
