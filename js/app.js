...
const REGION_DATA=[
  ...
  {"id":"moon","name":"월광의 섬","icon":"🌙","className":"isle-moon","visual":"region-visual-moon","level":20,"unlocked":true,"unlock":"제한 없이 입장 가능","legend":"월광 실버피쉬","legendIcon":"🐟","legendCondition":"밤 시간대 출현","desc":"달빛이 물결 위로 번지는 고요한 바다"},
  {"id":"emerald","name":"에메랄드 호수","icon":"💚","className":"isle-emerald","visual":"region-visual-emerald","level":30,"unlocked":true,"unlock":"제한 없이 입장 가능","legend":"에메랄드 드래곤","legendIcon":"🐉","legendCondition":"고급 미끼 사용 시 출현","desc":"에메랄드 빛 호수에 비밀 어종이 숨어있는 곳"},
  {"id":"crystal","name":"별빛 계곡","icon":"💎","className":"isle-crystal","visual":"region-visual-crystal","level":40,"unlocked":true,"unlock":"제한 없이 입장 가능","legend":"수정 만타","legendIcon":"🐠","legendCondition":"협곡 수집률 70% 달성","desc":"수정빛 물결과 별가루가 반짝이는 계곡"},
  {"id":"coral","name":"산호 낙원","icon":"🏝","className":"isle-coral","visual":"region-visual-coral","level":50,"unlocked":true,"unlock":"제한 없이 입장 가능","legend":"산호 해룡","legendIcon":"🐉","legendCondition":"희귀 물고기 5종 획득","desc":"알록달록 산호 군락이 펼쳐진 희귀 어종 서식지"},
  {"id":"rainbow","name":"황혼의 바다","icon":"🌅","className":"isle-rainbow","visual":"region-visual-rainbow","level":60,"unlocked":true,"unlock":"제한 없이 입장 가능","legend":"무지개 고래","legendIcon":"🐋","legendCondition":"폭포 지역 10회 낚시 성공","desc":"석양과 무지개가 만나는 환상의 바다"},
  {"id":"storm","name":"폭풍의 해역","icon":"⚡","className":"isle-storm","visual":"region-visual-storm","level":70,"unlocked":true,"unlock":"제한 없이 입장 가능","legend":"폭풍 상어","legendIcon":"🦈","legendCondition":"폭풍 시간대 출현","desc":"번개와 거친 파도 사이로 전설이 출현하는 해역"},
  {"id":"glacier","name":"영원의 빙하","icon":"❄️","className":"isle-glacier","visual":"region-visual-glacier","level":80,"unlocked":true,"unlock":"제한 없이 입장 가능","legend":"빙하 크라켄","legendIcon":"🦑","legendCondition":"도감 수집률 70% 달성","desc":"얼음으로 뒤덮인 극한의 최상위 어종 서식지"},
  {"id":"abyss","name":"심연의 해구","icon":"🕳","className":"isle-abyss","visual":"region-visual-abyss","level":90,"unlocked":true,"unlock":"제한 없이 입장 가능","legend":"심연의 고래","legendIcon":"🐋","legendCondition":"전설 미끼 사용","desc":"빛이 닿지 않는 깊은 해구, 거대 생명체의 영역"},
  {"id":"origin","name":"태초의 심해","icon":"🌌","className":"isle-origin","visual":"region-visual-origin","level":100,"unlocked":true,"unlock":"제한 없이 입장 가능","legend":"창세 아틀란티스 드래곤","legendIcon":"🐉","legendCondition":"도감 수집률 95% 달성","desc":"전설 속 생명체가 잠든 최종 심해"}
];
...
const SHOP_BAIT_TYPE_BY_ID = {
  ...
  'shrimp-20':'shrimp','shrimp-50':'shrimp','krill-50':'krill','glow-30':'glow','aroma-30':'aroma',
  'mist-bait':'mist','moon-bait':'moon','emerald-bait':'emerald','star-bait':'star','coral-bait':'coral','twilight-bait':'twilight',
  'storm-bait':'storm','glacier-bait':'glacier','abyss-bait':'abyss','origin-bait':'origin',
  'dragon-bait':'legend','kraken-bait':'legend','sea-god-bait':'legend','meteor-bait':'legend','tear-bait':'abyss','heart-bait':'legend','scale-bait':'legend','myth-bait':'legend','origin-essence-bait':'origin','legend-bait':'legend'
};
const REGION_RECOMMENDED_BAIT = {
  '안개의 섬':'mist','월광의 섬':'moon','에메랄드 호수':'emerald','별빛 계곡':'star','산호 낙원':'coral','황혼의 바다':'twilight','폭풍의 해역':'storm','영원의 빙하':'glacier','심연의 해구':'abyss','태초의 심해':'origin'
};
