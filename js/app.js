...
const REGION_DATA=[
  {"id":"mist","name":"안개의 섬","icon":"🌫","className":"isle-mist","visual":"region-visual-mist","level":1,"unlocked":true,"unlock":"처음부터 입장 가능","legend":"안개의 고대붕어","legendIcon":"🐟","legendCondition":"연못 수집률 80% 달성","desc":"짙은 안개에 가려진 신비로운 시작의 섬"},
  {"id":"moon","name":"월광의 섬","icon":"🌙","className":"isle-moon","visual":"region-visual-moon","level":5,"unlocked":true,"unlock":"Lv.5 달성 시 입장 가능","legend":"월광 실버피쉬","legendIcon":"🐟","legendCondition":"밤 시간대 출현","desc":"달빛이 물결 위로 번지는 고요한 바다"},
  {"id":"emerald","name":"에메랄드 호수","icon":"💚","className":"isle-emerald","visual":"region-visual-emerald","level":10,"unlocked":true,"unlock":"Lv.10 달성 시 입장 가능","legend":"에메랄드 드래곤","legendIcon":"🐉","legendCondition":"고급 미끼 사용 시 출현","desc":"에메랄드 빛 호수에 비밀 어종이 숨어있는 곳"},
  {"id":"crystal","name":"별빛 계곡","icon":"💎","className":"isle-crystal","visual":"region-visual-crystal","level":15,"unlocked":true,"unlock":"Lv.15 달성 시 입장 가능","legend":"수정 만타","legendIcon":"🐠","legendCondition":"협곡 수집률 70% 달성","desc":"수정빛 물결과 별가루가 반짝이는 계곡"},
  {"id":"coral","name":"산호 낙원","icon":"🏝","className":"isle-coral","visual":"region-visual-coral","level":20,"unlocked":true,"unlock":"Lv.20 달성 시 입장 가능","legend":"산호 해룡","legendIcon":"🐉","legendCondition":"희귀 물고기 5종 획득","desc":"알록달록 산호 군락이 펼쳐진 희귀 어종 서식지"},
  {"id":"rainbow","name":"황혼의 바다","icon":"🌅","className":"isle-rainbow","visual":"region-visual-rainbow","level":30,"unlocked":true,"unlock":"Lv.30 달성 시 입장 가능","legend":"무지개 고래","legendIcon":"🐋","legendCondition":"폭포 지역 10회 낚시 성공","desc":"석양과 무지개가 만나는 환상의 바다"},
  {"id":"storm","name":"폭풍의 해역","icon":"⚡","className":"isle-storm","visual":"region-visual-storm","level":40,"unlocked":true,"unlock":"Lv.40 달성 시 입장 가능","legend":"폭풍 상어","legendIcon":"🦈","legendCondition":"폭풍 시간대 출현","desc":"번개와 거친 파도 사이로 전설이 출현하는 해역"},
  {"id":"glacier","name":"영원의 빙하","icon":"❄️","className":"isle-glacier","visual":"region-visual-glacier","level":50,"unlocked":true,"unlock":"Lv.50 달성 시 입장 가능","legend":"빙하 크라켄","legendIcon":"🦑","legendCondition":"도감 수집률 70% 달성","desc":"얼음으로 뒤덮인 극한의 최상위 어종 서식지"},
  {"id":"abyss","name":"심연의 해구","icon":"🕳","className":"isle-abyss","visual":"region-visual-abyss","level":60,"unlocked":true,"unlock":"Lv.60 달성 시 입장 가능","legend":"심연의 고래","legendIcon":"🐋","legendCondition":"전설 미끼 사용","desc":"빛이 닿지 않는 깊은 해구, 거대 생명체의 영역"},
  {"id":"origin","name":"태초의 심해","icon":"🌌","className":"isle-origin","visual":"region-visual-origin","level":70,"unlocked":true,"unlock":"Lv.70 달성 시 입장 가능","legend":"창세 아틀란티스 드래곤","legendIcon":"🐉","legendCondition":"도감 수집률 95% 달성","desc":"전설 속 생명체가 잠든 최종 심해"}
];


const RODS=[
{id:'mist',name:'안개의 낚싯대',grade:'일반',level:1,price:0,rareBonus:0,epicBonus:0,legendBonus:0,pointBonus:2,effects:['희귀 확률 +3%','전설 확률 +0%','포인트 증가 +2%']},
{id:'emerald',name:'에메랄드 낚싯대',grade:'희귀',level:5,price:800,rareBonus:4,epicBonus:0.2,legendBonus:0,pointBonus:4,effects:['희귀 확률 +2%','영웅 확률 +0.2%','포인트 증가 +3%']},
{id:'moon',name:'월광의 낚싯대',grade:'희귀',level:10,price:2000,rareBonus:5,epicBonus:0.4,legendBonus:0.01,pointBonus:6,effects:['희귀 확률 +2%','영웅 확률 +0.3%','전설 확률 +0.01%']},
{id:'star',name:'별빛의 낚싯대',grade:'영웅',level:15,price:4500,rareBonus:5,epicBonus:0.6,legendBonus:0.02,pointBonus:8,effects:['희귀 확률 +1%','영웅 확률 +0.5%','전설 확률 +0.02%']},
{id:'coral',name:'산호의 낚싯대',grade:'영웅',level:20,price:9000,rareBonus:6,epicBonus:0.8,legendBonus:0.03,pointBonus:10,effects:['희귀 확률 +1%','영웅 확률 +0.8%','전설 확률 +0.03%']},
{id:'twilight',name:'황혼의 낚싯대',grade:'영웅',level:30,price:18000,rareBonus:6,epicBonus:1.0,legendBonus:0.03,pointBonus:12,effects:['희귀 확률 +1%','영웅 확률 +1.0%','포인트 증가 +12%']},
{id:'storm',name:'폭풍의 낚싯대',grade:'영웅',level:40,price:35000,rareBonus:7,epicBonus:1.2,legendBonus:0.04,pointBonus:14,effects:['영웅 확률 +1.2%','전설 확률 +0.04%','포인트 증가 +13%']},
{id:'glacier',name:'빙하의 낚싯대',grade:'영웅',level:50,price:70000,rareBonus:8,epicBonus:1.4,legendBonus:0.04,pointBonus:16,effects:['영웅 확률 +1.3%','전설 확률 +0.04%','포인트 증가 +14%']},
{id:'abyss',name:'심연의 낚싯대',grade:'전설',level:60,price:120000,rareBonus:8,epicBonus:1.7,legendBonus:0.05,pointBonus:20,effects:['영웅 확률 +1.5%','전설 확률 +0.05%','포인트 증가 +15%']},
{id:'origin',name:'태초의 낚싯대',grade:'전설',level:70,price:200000,rareBonus:9,epicBonus:2.0,legendBonus:0.08,pointBonus:25,effects:['영웅 확률 +2.0%','전설 확률 +0.08%','포인트 증가 +20%']},
...
const SHOP_ITEMS={"bait":[
{"id":"bait-10","icon":"🪱","name":"일반 미끼 10개","desc":"초반 낚시에 부담 없는 기본 묶음","price":100,"type":"bait","amount":10},
{"id":"bait-30","icon":"🪱","name":"일반 미끼 30개","desc":"가볍게 이어서 즐기는 기본 묶음","price":270,"type":"bait","amount":30},
{"id":"bait-50","icon":"🪱","name":"일반 미끼 50개","desc":"일일 미션까지 노려볼 수 있는 묶음","price":430,"type":"bait","amount":50},
{"id":"bait-100","icon":"🪱","name":"일반 미끼 100개","desc":"장시간 낚시에 적합한 실속 묶음","price":800,"type":"bait","amount":100},
{"id":"bait-200","icon":"🪱","name":"일반 미끼 200개","desc":"대량 구매 할인형 묶음 상품","price":1500,"type":"bait","amount":200},
{"id":"shrimp-10","icon":"🦐","name":"새우 미끼 10개","desc":"희귀 물고기 확률을 조금 높이는 미끼","price":300,"type":"bait","amount":10},
{"id":"shrimp-30","icon":"🦐","name":"새우 미끼 30개","desc":"중급 낚시에 어울리는 희귀 공략 묶음","price":850,"type":"bait","amount":30},
{"id":"shrimp-50","icon":"🦐","name":"새우 미끼 50개","desc":"희귀 수집을 꾸준히 노리는 실속 묶음","price":1350,"type":"bait","amount":50},
{"id":"special-5","icon":"✨","name":"특수 미끼 5개","desc":"영웅 이상 등급을 노리는 고급 미끼","price":500,"type":"bait","amount":5},
{"id":"special-20","icon":"✨","name":"특수 미끼 20개","desc":"영웅·전설 수집을 위한 고급 묶음","price":1800,"type":"bait","amount":20},
{"id":"legend-bait","icon":"👑","name":"전설의 미끼 1개","desc":"전설급 물고기를 집중 공략하는 미끼","price":5000,"type":"bait","amount":1}
...
const ECONOMY_BALANCE = {
  startPoint: 500,
  startBait: 20,
  dailyPlayTarget: '30분 / 150~200회',
  loop: ['미끼 구매','낚시','도감 등록','판매 포인트 획득','낚싯대 강화','지역 해금']
};

const BAIT_INFO = {
  normal: {icon:'🪱', name:'일반 미끼'},
  shrimp: {icon:'🦐', name:'새우 미끼'},
  krill: {icon:'🦐', name:'크릴 미끼'},
  glow: {icon:'✨', name:'반짝 미끼'},
  special: {icon:'✨', name:'특수 미끼'},
  aroma: {icon:'🌿', name:'향기 미끼'},
  mist: {icon:'🌫️', name:'안개 미끼'},
  moon: {icon:'🌙', name:'월광 미끼'},
  emerald: {icon:'💚', name:'에메랄드 미끼'},
  star: {icon:'⭐', name:'별빛 미끼'},
  coral: {icon:'🪸', name:'산호 미끼'},
  twilight: {icon:'🌅', name:'황혼 미끼'},
  storm: {icon:'🌩️', name:'폭풍 미끼'},
  glacier: {icon:'🧊', name:'빙하 미끼'},
  abyss: {icon:'🕳️', name:'심연 미끼'},
  origin: {icon:'🌌', name:'태초 미끼'},
  legend: {icon:'👑', name:'전설 미끼'}
};
const SHOP_BAIT_TYPE_BY_ID = {
  'bait-10':'normal','bait-30':'normal','bait-50':'normal','bait-100':'normal','bait-200':'normal',
  'shrimp-10':'shrimp','shrimp-30':'shrimp','shrimp-50':'shrimp',
  'special-5':'special','special-20':'special','legend-bait':'legend'
};
const REGION_RECOMMENDED_BAIT = {
  '안개의 섬':'normal','월광의 섬':'shrimp','에메랄드 호수':'shrimp','별빛 계곡':'special','산호 낙원':'special','황혼의 바다':'special','폭풍의 해역':'legend','영원의 빙하':'legend','심연의 해구':'legend','태초의 심해':'legend'
};
function syncBaitInventory(){
  if(!state.baitInventory) state.baitInventory = {normal:Number(state.bait || 0)};
  state.bait = getTotalBaitInventory(false);
}
function getTotalBaitInventory(shouldSync = true){
  if(shouldSync && !state.baitInventory) state.baitInventory = {normal:Number(state.bait || 0)};
  return Object.values(state.baitInventory || {}).reduce((sum, count) => sum + Number(count || 0), 0);
}
function getPreferredBaitType(){
  return REGION_RECOMMENDED_BAIT[state.selectedRegion] || 'normal';
}
function consumeBaitFromInventory(){
  syncBaitInventory();
  const preferred = getPreferredBaitType();
  const order = [preferred, 'normal', ...Object.keys(state.baitInventory || {}).filter(key => key !== preferred && key !== 'normal')];
  const key = order.find(type => Number(state.baitInventory?.[type] || 0) > 0);
  if(!key) return null;
  state.baitInventory[key] = Math.max(0, Number(state.baitInventory[key] || 0) - 1);
  state.bait = getTotalBaitInventory(false);
  state.lastUsedBaitType = key;
  return key;
}
function getBaitInventoryEntries(){
  syncBaitInventory();
  return Object.entries(state.baitInventory)
    .map(([key,count]) => ({key, count:Number(count || 0), ...(BAIT_INFO[key] || {icon:'🪱', name:'미끼'})}))
    .filter(item => item.count > 0);
}
function addBaitInventory(type, amount){
  syncBaitInventory();
  const key = type || 'normal';
  state.baitInventory[key] = Number(state.baitInventory[key] || 0) + Number(amount || 1);
  state.bait = getTotalBaitInventory(false);
}

const state={
point:500,bait:20,baitInventory:{normal:20},totalFishCaught:0,weeklyFishCaught:0,weeklyPoint:0,perfectCount:0,rareCount:0,heroCount:0,legendCount:0,soldFishCount:0,lastCatch:null,selectedRegion:'안개의 섬',currentRodId:'mist',rodLevel:1,unlockedRodIds:new Set(['mist']),currentMissionTab:'daily',currentCollectionFilter:'전체',currentShopTab:'bait',currentAchievementTab:'collection',currentRankingTab:'weekly',discoveredFishIds:new Set(DISCOVERED_INITIAL),
...
// 알림은 화면에 고정 문구를 박아두지 않고 현재 게임 상태에서 생성합니다.
state.readNotificationIds = new Set();
state.seenFishNotificationIds = new Set(DISCOVERED_INITIAL);
...
function getReadyMissions(){
  ...
  return Object.entries(state.missions || {})
    .filter(([,m]) => m && !m.claimed && Number(m.current || 0) >= Number(m.goal || 1));
}
...
function buildNotifications(){
  ...
  // 일자별 이벤트 알림
  list.push({
    id: `event:bite:${todayKey()}`,
    icon: '🎣',
    text: '오늘의 입질 이벤트가 시작되었습니다.',
    target: 'fishing',
    label: '낚시하러 가기'
  });

  // 미션 완료/보상 수령 가능 알림
  const readyMissions = getReadyMissions();
  if(readyMissions.length){
    list.push({
      id: `mission:ready:${readyMissions.map(([key]) => key).sort().join('|')}`,
      icon: '🎁',
      text: readyMissions.length === 1
        ? `${readyMissions[0][1].label} 보상을 수령할 수 있습니다.`
        : `수령 가능한 미션 보상이 ${readyMissions.length}개 있습니다.`,
      target: 'mission',
      label: '미션으로 이동'
    });
  }
  ...
  // 낚시 결과 신규 도감 등록 알림
  if(state.lastCatch && state.lastCatch.isNew){
    list.push({
      id: `fish:new:${state.lastCatch.fishId}`,
      icon: '📖',
      text: `${state.lastCatch.name}이(가) 도감에 새로 등록되었습니다.`,
      target: 'collection',
      label: '도감으로 이동'
    });
  }
...
function getUnreadNotifications(){
  return buildNotifications().filter(item => !state.readNotificationIds.has(item.id));
}

function renderNotificationItems(items){
  if(!items.length){
    return '<div class="notification-empty">확인할 새 알림이 없습니다.</div>';
  }
  return `<ul class="notification-list">${items.map(item => `
    <li>
      <button type="button" class="notification-link" data-notification-id="${item.id}" data-notification-target="${item.target || 'home'}" aria-label="${item.label || '관련 화면으로 이동'}">
...
function markNotificationsRead(items = buildNotifications()){
  items.forEach(item => state.readNotificationIds.add(item.id));
}

function getRegionStage(region){
  const index = REGION_DATA.findIndex(item => item.name === region.name);
  const stage = Math.max(1, index + 1);
  const labels = ['초보자 지역','성장 지역','탐험 지역','중급 지역','상급 지역','숙련 지역','전문가 지역','마스터 지역','심연 지역','최종 지역'];
  const levelLabels = ['초보자','성장','탐험','중급','상급','숙련','전문가','마스터','심연','최종'];
  return {
    stage,
    stars: `STAGE ${stage}/10`,
    tier: labels[index] || '특수 지역',
    levelLabel: levelLabels[index] || '특수'
  };
}

function getLegendGrade(region){
  return region.level >= 100 ? 'MYTHIC' : 'LEGENDARY';
}

function getPlayerLevel(){
  const info = getPlayerLevelInfo ? getPlayerLevelInfo() : {level:1};
  return Number(info.level || 1);
}

function canEnterRegion(region){
  if(!region) return false;
  const requiredLevel = Number(region.level || 1);
  return region.unlocked !== false && getPlayerLevel() >= requiredLevel;
}

function regionLockMessage(region){
  const requiredLevel = Number(region?.level || 1);
  const currentLevel = getPlayerLevel();
  if(requiredLevel <= 1) return '처음부터 입장할 수 있는 시작 지역입니다.';
  return `현재 Lv.${currentLevel}입니다.<br>이 지역은 Lv.${requiredLevel} 이상부터 입장할 수 있어요.`;
}

function getRegionStatusText(region, selected=false){
  if(selected) return '선택됨';
  if(canEnterRegion(region)) return '입장 가능';
  return `Lv.${Number(region.level || 1)} 필요`;
}

function getRegionStatusClass(region, selected=false){
  if(selected) return 'selected';
  return canEnterRegion(region) ? 'available' : 'locked';
}
...
const REGION_UI_THEME = {
  '안개의 섬': {accent:'#6FA99F', accent2:'#9ED4C7', bg:'#ECFAF8', panel:'#FFF6E8'},
  '월광의 섬': {accent:'#6B5DCA', accent2:'#9B86F2', bg:'#F1EFFF', panel:'#FFF6E8'},
  '별빛 계곡': {accent:'#765ED7', accent2:'#B58BFF', bg:'#F5F0FF', panel:'#FFF6E8'},
  '에메랄드 호수': {accent:'#20AFA2', accent2:'#65D9C4', bg:'#ECFBF6', panel:'#FFF6E8'},
  '황혼의 바다': {accent:'#FF8A4B', accent2:'#FFC067', bg:'#FFF4E9', panel:'#FFF6E8'},
  '산호 낙원': {accent:'#24C5B2', accent2:'#63DCE0', bg:'#EFFFFB', panel:'#FFF6E8'},
  '폭풍의 해역': {accent:'#405B7E', accent2:'#6F86A8', bg:'#EEF4FA', panel:'#FFF6E8'},
  '심연의 해구': {accent:'#1E91C6', accent2:'#4EC8DF', bg:'#EAF8FF', panel:'#FFF6E8'},
  '영원의 빙하': {accent:'#4EADEB', accent2:'#95D8FF', bg:'#EEF9FF', panel:'#FFF6E8'},
  '태초의 심해': {accent:'#1DA4C9', accent2:'#4ED1D6', bg:'#EAFBFF', panel:'#FFF6E8'}
};

function applyRegionTheme(regionName){
  const theme = REGION_UI_THEME[regionName] || REGION_UI_THEME['안개의 섬'];
  const root = document.documentElement;
  root.style.setProperty('--region-accent', theme.accent);
  root.style.setProperty('--region-accent-2', theme.accent2);
  root.style.setProperty('--region-bg', theme.bg);
  root.style.setProperty('--region-panel', theme.panel);
}
...
function getRegionGuideHtml(regionName = state.selectedRegion){
  const region = getRegionByName(regionName || '안개의 섬');
  const stage = getRegionStage(region);
  const fishList = getRegionFish(region.name);
  const normalFish = fishList.filter(f => f.grade === '일반').slice(0, 3);
  const rareFish = fishList.filter(f => f.grade === '희귀').slice(0, 2);
  const previewFish = [...normalFish, ...rareFish].slice(0, 5);
  const baitKey = REGION_RECOMMENDED_BAIT[region.name] || 'normal';
  const baitInfo = BAIT_INFO[baitKey] || BAIT_INFO.normal || {icon:'🪱', name:'일반 미끼'};
  syncBaitInventory();
  const baitCount = Number(state.baitInventory?.[baitKey] || 0);
  const {discovered, total, percent} = getRegionCollectionProgress(region.name);
  const difficulty = stage.stage <= 2 ? '★☆☆☆☆' : stage.stage <= 4 ? '★★☆☆☆' : stage.stage <= 6 ? '★★★☆☆' : stage.stage <= 8 ? '★★★★☆' : '★★★★★';
  return `
    <div class="region-guide">
      <div class="region-guide-hero">
        <span class="region-guide-icon">${escapeHtml(region.icon)}</span>
        <div>
          <strong>${escapeHtml(region.name)}</strong>
          <p>${escapeHtml(region.desc || '지역 정보를 확인해보세요.')}</p>
        </div>
      </div>
      <div class="region-guide-grid">
        <div><small>난이도</small><b>${difficulty}</b></div>
        <div><small>진행도</small><b>${percent}% · ${discovered}/${total}종</b></div>
        <div><small>입장 조건</small><b>Lv.${region.level} 이상</b></div>
        <div><small>스테이지</small><b>${escapeHtml(stage.stars)}</b></div>
      </div>
      <div class="region-guide-section">
        <h3>추천 미끼</h3>
        <div class="region-guide-bait"><span>${escapeHtml(baitInfo.icon)}</span><b>${escapeHtml(baitInfo.name)}</b><em>${baitCount.toLocaleString()}개 보유</em></div>
        <p class="region-guide-tip">이 지역에서는 추천 미끼를 사용하면 희귀 어종을 노리기 좋아요.</p>
      </div>
      <div class="region-guide-section">
        <h3>출현 어종</h3>
        <div class="region-guide-fishes">
          ${previewFish.map(f => `<span>${escapeHtml(f.name)}</span>`).join('') || '<span>정보 준비중</span>'}
        </div>
      </div>
      <div class="region-guide-section">
        <h3>전설 물고기</h3>
        <div class="region-guide-legend"><span>${escapeHtml(region.legendIcon || '🐟')}</span><b>${escapeHtml(region.legend || '전설 물고기')}</b><em>${escapeHtml(region.legendCondition || '조건 확인 필요')}</em></div>
      </div>
    </div>`;
}
...
function renderRegionDetail(regionName = state.selectedRegion){
  ...
  const progressBar = $('#regionProgressBar');
  const tierBadge = $('#regionTierBadge');
  const stars = $('#regionStars');
  const desc = $('#regionDescription');
  const levelLabel = $('#regionLevelLabel');
  const legendGrade = $('#regionLegendGrade');
  ...
  if(levelLabel) levelLabel.textContent = stage.levelLabel;
  if(tierBadge) tierBadge.textContent = `${region.icon} ${stage.tier}`;
  if(stars) stars.textContent = stage.stars;
  if(desc) desc.textContent = region.desc || '';
  if(legendGrade) legendGrade.textContent = getLegendGrade(region);
  ...
  if(enterBtn){
    const unlocked = canEnterRegion(region);
    enterBtn.disabled = !unlocked;
    enterBtn.classList.toggle('is-locked', !unlocked);
    enterBtn.innerHTML = unlocked
      ? '입장하기 <small>입장권 1개 사용</small>'
      : `잠김 <small>Lv.${Number(region.level || 1)} 이상 필요</small>`;
  }
}
...
function renderWorldMap(){
  ...
  const unlockedCount = REGION_DATA.filter(region => canEnterRegion(region)).length;
  ...
  map.innerHTML = REGION_DATA.map((region, index) => {
    ...
    const unlocked = canEnterRegion(region);
    const status = getRegionStatusText(region, selected);
    const statusClass = getRegionStatusClass(region, selected);
    const requiredLevel = Number(region.level || 1);
    return `<button type="button"
      class="island-node ${region.className} ${unlocked ? 'unlocked' : 'locked'} ${selected ? 'selected' : ''}"
      ...
      <small class="${statusClass}">${escapeHtml(status)}</small>
    </button>`;
  }).join('');
}
...
function modal(title,body,options={}){const el=$('#appModal'); if(!el)return; const type=options.type||''; const card=el.querySelector('.modal-card'); if(card){card.className='modal-card'; card.classList.toggle('is-menu-modal', title==='전체 메뉴'); if(type) card.classList.add('is-'+type+'-modal'); card.scrollTop=0;} const modalTitle=$('#modalTitle'); const modalBody=$('#modalBody'); if(modalTitle) modalTitle.textContent=title; if(modalBody) modalBody.innerHTML=body; el.dataset.modalType=type; el.classList.add('is-open'); el.setAttribute('aria-hidden','false'); requestAnimationFrame(()=>{if(card)card.scrollTop=0;});}
function closeModal(){const el=$('#appModal'); if(el){if(el.dataset.modalType==='notification'){markNotificationsRead(getUnreadNotifications()); updateNotificationBell();} el.classList.remove('is-open'); el.setAttribute('aria-hidden','true'); el.dataset.modalType='';}}
...
function renderCollection(filter=state.currentCollectionFilter){
  ...
  const count=$('#collectionCount'),donut=$('#collectionDonut'),grid=$('#fishGrid'),info=$('#collectionFilterInfo'),summary=$('#collectionSummaryBadge');
  if(count)count.textContent=`${discovered} / ${ALL_FISH.length} 종류`;
  if(summary){
    summary.textContent=`${discovered}/${ALL_FISH.length}`;
    summary.title=`발견 ${discovered}종 / 전체 ${ALL_FISH.length}종`;
    summary.classList.toggle('is-complete', discovered===ALL_FISH.length);
  }
...
function renderRods(){
  ...
  const rodSummary=$('#rodSummaryBadge');
  if(rodSummary){
    const ownedCount=RODS.filter(rod=>isRodUnlocked(rod)).length;
    const totalCount=RODS.length;
    rodSummary.textContent=`${ownedCount}/${totalCount}`;
    rodSummary.title=`보유 낚싯대 ${ownedCount}개 / 전체 ${totalCount}개`;
    rodSummary.classList.toggle('is-complete', ownedCount===totalCount);
  }
...
function renderAchievements(){
  ...
  const achievementSummary=$('#achievementSummaryBadge');
  if(achievementSummary){
    const allAchievements=Object.values(ACHIEVEMENTS).flat();
    const completedCount=allAchievements.filter(item=>getAchievementProgress(item)>=item.goal).length;
    const totalCount=allAchievements.length;
    achievementSummary.textContent=`${completedCount}/${totalCount}`;
    achievementSummary.title=`완료 업적 ${completedCount}개 / 전체 업적 ${totalCount}개`;
    achievementSummary.classList.toggle('is-complete', totalCount>0 && completedCount===totalCount);
  }
...
function renderHomeStats(){
  ...
  const bait = $('#homeBait');
  const baitChips = $('#homeBaitChips');
  const recommendedBait = $('#homeRecommendedBait');
  ...
  syncBaitInventory();
  const baitEntries = getBaitInventoryEntries();
  const totalBaitCount = getTotalBaitInventory(false);
  if(point) point.textContent = `${state.point.toLocaleString()} P`;
  if(shopPoint) shopPoint.textContent = `${state.point.toLocaleString()}P`;
  if(bait) bait.textContent = `${totalBaitCount.toLocaleString()} 개`;
  if(baitChips){
    const visible = baitEntries.slice(0,5).map(item => `<span title="${item.name}">${item.icon}<b>${item.count.toLocaleString()}</b></span>`).join('');
    const more = baitEntries.length > 5 ? `<span class="more">+${baitEntries.length - 5}</span>` : '';
    baitChips.innerHTML = visible || '<span>🪱<b>0</b></span>';
    if(more) baitChips.insertAdjacentHTML('beforeend', more);
  }
  if(recommendedBait){
    const regionName = state.selectedRegion || '안개의 섬';
    const key = REGION_RECOMMENDED_BAIT[regionName] || 'normal';
    const info = BAIT_INFO[key] || BAIT_INFO.normal;
    const count = Number(state.baitInventory?.[key] || 0);
    const icon = $('.recommended-bait-icon', recommendedBait);
    const title = $('strong', recommendedBait);
    const desc = $('p', recommendedBait);
    const btn = $('button', recommendedBait);
    if(icon) icon.textContent = info.icon;
    if(title) title.textContent = '추천 미끼';
    if(desc) desc.innerHTML = `<b>${info.name}</b> ${count.toLocaleString()}개 보유 · ${regionName} 추천`;
    if(btn) btn.textContent = count > 0 ? '상점' : '구매';
  }
...
function renderRanking(){
  ...
  const rankingSummary=$('#rankingSummaryBadge');
  if(rankingSummary){
    const baseType=state.currentRankingTab === 'total' ? 'total' : 'weekly';
    const mineRow=getRankedRows(baseType).find(item=>item.mine);
    const rankText=mineRow ? `${mineRow.rank}위` : '-위';
    rankingSummary.textContent=rankText;
    rankingSummary.title=`나의 ${baseType==='weekly'?'주간':'전체'} 랭킹 ${rankText}`;
    rankingSummary.classList.toggle('is-top', mineRow && mineRow.rank<=3);
  }
...
function getRodEnhanceCost(){
  const level = Number(state.rodLevel || 1);
  if(level <= 1) return 300;
  if(level === 2) return 700;
  if(level === 3) return 1500;
  if(level === 4) return 3000;
  return Math.round(3000 * Math.pow(1.28, level - 4));
}
...
const BAIT_GRADE_BONUS = {
  normal: {rare:0, epic:0, legend:0},
  shrimp: {rare:4, epic:0.3, legend:0},
  special: {rare:2, epic:2.0, legend:0.2},
  legend: {rare:0, epic:3.0, legend:1.0}
};
...
function getCurrentGradeRates(){
  ...
  const baitBonus = BAIT_GRADE_BONUS[state.lastUsedBaitType || 'normal'] || BAIT_GRADE_BONUS.normal;
  const rare = 6.9 + Number(rod.rareBonus || 0) + Number(baitBonus.rare || 0);
  const epic = 1.0 + Number(rod.epicBonus || 0) + Number(baitBonus.epic || 0);
  const legend = 0.1 + Number(rod.legendBonus || 0) + Number(baitBonus.legend || 0);
...
function getFishSellPoint(fish){
  if(!fish) return 0;
  const gradeBase = {'일반':10, '희귀':55, '영웅':150, '전설':700};
  const base = gradeBase[fish.grade] || 8;
  const variance = Math.max(0, Number(fish.id || 0) % 7 - 3);
  return Math.max(5, base + variance * (fish.grade === '일반' ? 1 : fish.grade === '희귀' ? 3 : fish.grade === '영웅' ? 8 : 25));
}
...
function getRewardByResult(j, fish){
  ...
  if(j.result === 'perfect'){
    return {point: Math.round(getFishSellPoint(fish) * 1.5 * pointRate), exp: 80};
  }
  if(j.result === 'success'){
    return {point: Math.round(getFishSellPoint(fish) * pointRate), exp: 40};
  }
...
function hasFishingBait(){
  return getTotalBaitInventory() > 0;
}
...
function consumeFishingBait(){
  ...
  const usedType = consumeBaitFromInventory();
  if(!usedType){
    toast('미끼가 부족합니다. 상점에서 미끼를 구매해 주세요.');
    renderFishingButtonState();
    return false;
...
if(t.closest('.modal-x') || t.closest('[data-close-modal]')){e.preventDefault(); closeModal();return;}
if(t.closest('#regionHelp')){e.preventDefault(); modal('지역 가이드', getRegionGuideHtml(state.selectedRegion), {type:'regionGuide'}); return;}
const notificationLink=t.closest('[data-notification-target]');
if(notificationLink){
  const notificationId=notificationLink.dataset.notificationId;
  const targetScreen=notificationLink.dataset.notificationTarget || 'home';
  if(notificationId) state.readNotificationIds.add(notificationId);
  updateNotificationBell();
  const modalEl = document.getElementById('appModal');
  if(modalEl){
    modalEl.dataset.modalType = '';
...
const qa=t.closest('.quiz-answer'); if(qa){if(qa.dataset.answer==='right'){closeModal(); setMission('quiz',1); setMission('financeQuiz',1); toast('정답입니다! 금융 퀴즈 미션 완료'); renderAll();
updateNotificationBell();}else toast('아쉬워요. 다시 선택해보세요.'); return;}
const fin=t.closest('[data-finance-mission]'); if(fin){setMission(fin.dataset.financeMission,1); renderAll();
updateNotificationBell(); modal('금융 미션','<p style="line-height:1.55;margin:0">데모에서는 해당 금융 미션을 완료 처리했습니다.<br>수령 버튼을 눌러 보상을 받을 수 있습니다.</p>'); return;}
if(t.closest('[data-product-mission], #productBanner')){setMission('product',1); renderAll();
updateNotificationBell(); modal('상품 페이지 방문','<p class="simple-guide-message">상품 페이지 방문 미션이<br>완료되었습니다.</p>'); return;}
if(t.closest('#regionEnterBtn')){
  const region = getRegionByName(state.selectedRegion || '안개의 섬');
  if(!canEnterRegion(region)){
    modal('입장 조건 부족', `<p class="simple-guide-message">${regionLockMessage(region)}</p>`);
    return;
  }
  setFishingRegion(region.name);
  showScreen('fishing');
  return;
}
...
if(t.closest('#enhanceBtn')){const cost=getRodEnhanceCost(); if(state.point<cost){toast(`${cost.toLocaleString()}P가 필요합니다.`);return;} state.point-=cost; state.rodLevel+=1; renderRods(); renderHomeStats(); toast(`${currentRod().name} 강화 성공! Lv.${state.rodLevel}`); return;}
const bi=t.closest('[data-buy-id]'); if(bi){const item=Object.values(SHOP_ITEMS).flat().find(x=>x.id===bi.dataset.buyId); if(!item)return; if(state.point<item.price){toast('포인트가 부족합니다.');return;} state.point-=item.price; if(item.type==='bait'){addBaitInventory(SHOP_BAIT_TYPE_BY_ID[item.id] || 'normal', item.amount || 1);} renderAll();
updateNotificationBell(); const productName=(item.name||'상품').replace(/\s*\d+개$/,''); const productAmount=(item.amount||1).toLocaleString()+'개'; modal('구매 완료',`<div class="purchase-complete"><p class="purchase-message">구매가 완료되었습니다.</p><dl class="purchase-summary"><div><dt>구매 상품</dt><dd><strong>${productName}</strong><span>${productAmount}</span></dd></div><div><dt>차감 포인트</dt><dd><strong>${item.price.toLocaleString()}P</strong></dd></div></dl></div>`); return;}
const region=t.closest('[data-region]'); if(region){
const regionName=region.dataset.region;
const data=getRegionByName(regionName);
if(!canEnterRegion(data)){
  modal('입장 조건 부족', `<p class="simple-guide-message">${regionLockMessage(data)}</p>`);
  renderWorldMap();
  return;
}
...
function updateNotificationBell(){
  ...
  btn.classList.remove('icon_bell','icon_bell_on','on');
  btn.classList.add(hasUnreadNotifications ? 'icon_bell_on' : 'icon_bell');
  btn.setAttribute('aria-label', hasUnreadNotifications ? '새 알림 있음' : '알림');
}

$('#notifyBtn')?.addEventListener('click',()=>{
  const items = getUnreadNotifications();
  modal('알림', renderNotificationItems(items), {type:'notification'});
});
